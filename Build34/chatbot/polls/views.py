        ...
        if type(email)==str:
            ...
            if create_pass==confirm_pass:
                ...
                if result:
                    ...
                    return render(request,'regindex.html',{'messages':'Failed to register user'})
            else:
                return render(request,'regindex.html',{'messages':'Create and Confirm password doesnt match!'})
