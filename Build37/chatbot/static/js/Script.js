    ...
    fetch('', {
        ...
        .then( data => {
          ...
          setTimeout(()=>{
            ...
            }else if(res[1]=="canadmission"){
              chatbox.appendChild(createChatLi("Sorry if you feel inconvienent","incoming"));
              chatbox.appendChild(createChatLi("You can give your feedback our authority will fix it","incoming"));
              chatInput.value="Feedback : "
